...
* The original package name 'com.example.event.management.project .symboisys.demo.event.management.project .symboisys' is invalid and this project uses 'com.example.event.management.project.symboisys.demo.event.management.project.symboisys' instead.
